...
import numpy as np
from model import KGNN_LS,my_KGNN_LS
...
def train(args, data, show_loss, show_topk):
    ...
    model = my_KGNN_LS(args, n_user, n_entity, n_relation, adj_entity, adj_relation, interaction_table, offset)
